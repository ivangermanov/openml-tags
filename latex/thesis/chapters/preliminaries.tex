...
The zeroshot classification process can be broken down as follows:
\begin{itemize}
    ...
    \item \textbf{Model Evaluation}: A pre-trained NLI model is used to evaluate how well each hypothesis is entailed by the input text. In zeroshot classification, the model calculates the probability that each hypothesis is true, given the input text.
