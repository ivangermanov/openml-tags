...
\begin{figure}[h]
    ...
    \subfloat[Human-generated tags]{\includegraphics[width=0.45\textwidth]{figures/tags_correlations_human.pdf}\label{fig:tags_correlations_human}}
    \caption{Relevance and generality correlations comparison}
    \label{fig:tags_correlations}
\end{figure}

Additionally, we inspect the cumulative relevance and generality scores by tag type (regular vs. overarching tags, as explained in \cref{sec:tag_generation}) in \cref{fig:tags_analysis_human_multiple_documents} for human-generated tags and in \cref{fig:tags_analysis_model_multiple_documents} for the proposed model. We see that the relevance scores are higher for regular tags than for overarching tags, while the generality scores are higher for overarching tags than for regular tags. This second observation indicates that the pipeline we designed was successful in generating more specific tags for regular tags and more general tags for overarching tags.

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/tags_analysis_human_multiple_documents.pdf}
    \caption{Cumulative relevance and generality scores by tag type (human-generated)}
    \label{fig:tags_analysis_human_multiple_documents}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/tags_analysis_model_multiple_documents.pdf}
    \caption{Cumulative relevance and generality scores by tag type (proposed model)}
...
\begin{figure}[h]
    ...
    \begin{minipage}{.5\textwidth}
        ...
        \caption*{(d) Shared Coverage}
    \end{minipage}
    \caption{ICC values for different rating types (human-generated tags)}
    \label{fig:icc_human}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lccc}
        \hline
        \textbf{Metric} & \textbf{Baseline} & \textbf{Proposed Model} & \textbf{Human-Generated} \\
        \hline
...
The confusion matrices in \cref{fig:first_pair_common_tags_confusion_matrix_baseline}, \cref{fig:first_pair_common_tags_confusion_matrix_model}, and \cref{fig:first_pair_common_tags_confusion_matrix_human} show the common tags confusion matrix comparison for the first pair of texts. The confusion matrices in \cref{fig:second_pair_common_tags_confusion_matrix_baseline}, \cref{fig:second_pair_common_tags_confusion_matrix_model}, and \cref{fig:second_pair_common_tags_confusion_matrix_human} show the common tags confusion matrix comparison for the second pair of texts.
...
\begin{figure}[h]
    \centering
    \subfloat[Baseline model]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_confusion_matrix_baseline.pdf}\label{fig:first_pair_common_tags_confusion_matrix_baseline}}
    \hfill
    \subfloat[Proposed model]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_confusion_matrix_model.pdf}\label{fig:first_pair_common_tags_confusion_matrix_model}}

    \subfloat[Human-generated tags]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_confusion_matrix_human.pdf}\label{fig:first_pair_common_tags_confusion_matrix_human}}
    \caption{Common tags confusion matrix comparison for the first pair}
\end{figure}

\begin{figure}[h]
    \centering
    \subfloat[Baseline model]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_confusion_matrix_baseline.pdf}\label{fig:second_pair_common_tags_confusion_matrix_baseline}}
    \hfill
    \subfloat[Proposed model]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_confusion_matrix_model.pdf}\label{fig:second_pair_common_tags_confusion_matrix_model}}

    \subfloat[Human-generated tags]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_confusion_matrix_human.pdf}\label{fig:second_pair_common_tags_confusion_matrix_human}}
...
\begin{table}[h]
    ...
    \begin{tabular}{lcccccc}
        \hline
        \multirow{2}{*}{\textbf{Metric}} & \multicolumn{2}{c}{\textbf{Baseline}} & \multicolumn{2}{c}{\textbf{Proposed Model}} & \multicolumn{2}{c}{\textbf{Human-Generated}} \\
        \cline{2-7}
...
\begin{table}[h]
    ...
    \begin{tabular}{llrl}
        ...
        \multirow{3}{*}{Relevance} 
            & Baseline vs Human & -0.703 & Large \\
            & Baseline vs Model & -0.599 & Large \\
            & Human vs Model    &  0.163 & Small \\
        \hline
        \multirow{3}{*}{Generality}
            & Baseline vs Human &  0.014 & Negligible \\
            & Baseline vs Model &  0.112 & Negligible \\
            & Human vs Model    &  0.101 & Negligible \\
        \hline
        \multirow{3}{*}{Coverage}
            & Baseline vs Human & -0.885 & Large \\
            & Baseline vs Model & -0.888 & Large \\
            & Human vs Model    & -0.053 & Negligible \\
        \hline
        \multirow{3}{*}{Shared Coverage}
            & Baseline vs Human & -0.789 & Large \\
            & Baseline vs Model & -0.681 & Large \\
            & Human vs Model    &  0.200 & Small \\
        \hline
    \end{tabular}
...
\begin{table}[h]
    ...
    \begin{tabular}{llrl}
        ...
        \hline
        \multirow{3}{*}{Relevance} 
            & Baseline vs Human & -1.589 & Very Large \\
            & Baseline vs Model & -1.254 & Very Large \\
            & Human vs Model    &  0.293 & Small-Medium \\
        \hline
        \multirow{3}{*}{Generality}
            & Baseline vs Human &  0.027 & Negligible \\
            & Baseline vs Model &  0.202 & Small-Medium \\
            & Human vs Model    &  0.178 & Small \\
        \hline
        \multirow{3}{*}{Coverage}
            & Baseline vs Human & -2.454 & Very Large \\
            & Baseline vs Model & -2.539 & Very Large \\
            & Human vs Model    & -0.078 & Negligible \\
        \hline
        \multirow{3}{*}{Shared Coverage}
            & Baseline vs Human & -1.882 & Very Large \\
            & Baseline vs Model & -1.485 & Very Large \\
            & Human vs Model    &  0.391 & Small-Medium \\
        \hline
    \end{tabular}
...
\cref{fig:first_pair_common_tags_quality} and \cref{fig:second_pair_common_tags_quality} show the common tags coverage comparison for the first and second pairs, respectively.
...
\begin{figure}[h]
    \centering
    \subfloat[Baseline model]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_coverage_baseline.pdf}\label{fig:first_pair_common_tags_coverage_baseline}}
    \hfill
    \subfloat[Proposed model]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_coverage_model.pdf}\label{fig:first_pair_common_tags_coverage_model}}

    \subfloat[Human-generated tags]{\includegraphics[width=0.45\textwidth]{figures/first_pair_common_tags_coverage_human.pdf}\label{fig:first_pair_common_tags_coverage_human}}
...
\begin{figure}[h]
    \centering
    \subfloat[Baseline model]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_coverage_baseline.pdf}\label{fig:second_pair_common_tags_coverage_baseline}}
    \hfill
    \subfloat[Proposed model]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_coverage_model.pdf}\label{fig:second_pair_common_tags_coverage_model}}

    \subfloat[Human-generated tags]{\includegraphics[width=0.45\textwidth]{figures/second_pair_common_tags_coverage_human.pdf}\label{fig:second_pair_common_tags_coverage_human}}
